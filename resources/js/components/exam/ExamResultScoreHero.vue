...
const totalScore = computed(() => props.attempt.total_score ?? 0);
const maxScore = computed(() => props.attempt.max_score ?? 0);
        ...
        >
            <div class="space-y-2">
                ...
                <p class="max-w-xl text-sm text-muted-foreground">
                    Төменде әр бөлім бойынша нәтиже, сіздің жауаптарыңыз және
                    дұрыс жауаптар көрсетілген.
                </p>
            </div>
